...
import { SpaceCartMadal } from '../spaceCartMadal/SpaceCartMadal';
...
const SpaceCard: React.FC<SpaceCardProps> = ({ spaceCard }) => {
    ...
    <>
      ...
      >
        ...
        <Stack mt="md" mb="xs" align="center">
          ...
          <Text fw={500}>{spaceCard.rocket.rocket_name}</Text>
        </Stack>
